...
def line(end_x, end_y, name, feed = None, ramp_z = None, start_z = None):
    ...
    # cutter_x, cutter_y, cutter_z = line(end_x, end_y, name, feed, ramp_z, start_z)
    ...
    return(cutter_x, cutter_y, cutter_z)        # returns cutter position
...
def arc(end_x, end_y, name, rad, cw, less_180, feed = None, ramp_z = None, start_z = None):
    ...
    # Optional feed rate.
    # returns cutter position
    # cutter_x, cutter_y, cutter_z = arc(end_x, end_y, name, rad, cw, less_180, feed, ramp_z, start_z)
    ...
    if less_180 == True:
        rad_adjusted = rad     # positive sign for acute arc
    if less_180 == False:
        rad_adjusted = -rad    # negative sign for obtuse arc
...
def tri_slot(start_x, start_y, end_x, end_y, step, wos, dia, name, cutter_x, cutter_y, first_slot = True, last_slot = True, debug = False):
   ...
   # end_x_original, end_y_original, cutter_x_final, cutter_y_final = tri_slot(start_x, start_y, end_x, end_y, step, wos, dia, name, cutter_x, cutter_y, first_slot, last_slot, debug)
...
def tri_arc(start_x, start_y, end_x, end_y, step, wos, dia, rad_slot, cw, less_180, name, cutter_x, cutter_y, first_slot=True, last_slot=True, debug = False):
   ...
   # end_x_original, end_y_original, cutter_x_final, cutter_y_final = tri_arc(start_x, start_y, end_x, end_y, step, wos, dia, rad_slot, cw, less_180, name, cutter_x, cutter_y, first_slot, last_slot, debug)
...
text_temp = f'''G0 Z{"%.0f" % start_z}\n'''  # optional feed
write_g_code(name, text_temp)  # write g-code
...
# cutter_x, cutter_y, cutter_z = arc(end_x, end_y, name, rad, cw, less_180, feed, ramp_z, start_z)
#arc(end_x, end_y, name, rad, cw, less_180, feed, ramp_z, start_z)
...
df_csv = pd.read_csv('vector.csv')
df_tsv = pd.read_csv('vector.csv',delimiter='\t')
df_xlsx = pd.read_excel('vector.xlsx')
#print(f'{df_csv}\n')
#print(df_tsv)
print(df_xlsx)
#print('\n')
...
temp = df_xlsx.shape[0]
#print('\n')
print(f'# of rows = {temp}')

temp = df_xlsx.shape[1]
#print('\n')
print(f'# of columns = {temp}')

temp = df_xlsx['X'][3]
#print('\n')
print(f'element = {temp}')
# ===========================================================================
# ================================ G-code end ===============================
# ===========================================================================
