...
prefix = 'GCE'
file_name = 'PZT Bracket-01 Drill Holes'
rev = '01'
...
cut_f = 0  # cutting feed rate
z_f = 31  # plunge feed rate
finish_f = 0 # finish feed rate
rpm = 2900  # spindle speed
cutter_dia = 0.5  # diameter of cutter before adjustment
tol = 0    # adjustment for cutter tolerance
dia = cutter_dia + tol  # adjust cutter tolerance
loc = 12    # length of cutter
flute = 2   # number of flutes
surface_speed = 0  #Surface Speed (m/min)
chipload = 0 # Chipload (mm/tooth)
